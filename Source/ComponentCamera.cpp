...
void ComponentCamera::Center() //TODO: Shouldn't be specfic to editor camera
{
	...
	ComponentRenderer* objectRenderer = (ComponentRenderer*)App->scene->selected->GetComponentOld(ComponentType::Renderer);
	...
	else
	{
		...
		{
			ComponentRenderer* childRenderer = (ComponentRenderer*)child->GetComponentOld(ComponentType::Renderer);
