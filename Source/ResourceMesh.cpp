...
bool ResourceMesh::LoadInMemory()
{
	...
	if (normals != nullptr) bufferSize += sizeof(GLfloat)*numVertices * 3;
	if (texCoords != nullptr) bufferSize += sizeof(GLfloat)*numVertices * 2;
	...
	{
		offsetTexCoords = (texCoords != nullptr) ? sizeof(GLfloat) * 6 * numVertices : sizeof(GLfloat) * 3 * numVertices;
