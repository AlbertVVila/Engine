...
//	if (materialFile != nullptr && materialFile != material->name)
//	{
...
//}
//
//void ComponentMaterial::SetMaterial(const Material &mat) //TODO: add nbusages to resmanager -> only copy pointer!
//{
