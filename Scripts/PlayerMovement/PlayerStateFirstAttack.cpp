...
{
	if (!hitboxCreated && timer > player->firstAttackDuration * minTime && timer < player->firstAttackDuration * maxTime)
	{
		//Create the hitbox
	...
	if (hitboxCreated && timer > player->firstAttackDuration* maxTime)
	{
